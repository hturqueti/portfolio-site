...
tags:
  - livro
  - produtividade
image: "/images/posts/livro-essencialismo-a-disciplinada-busca-por-menos-de-greg-mckeown/cover.webp"
contentType: "post"
---
...
Essencialismo é dedicar-se a **fazer menos, porém melhor**. Ao focar apenas no que é realmente importante, em vez de tentar abarcar tudo, é que podemos oferecer nossa máxima contribuição.
...
A fase inicial da filosofia essencialista destaca a importância de manter a mente aberta a possibilidades que antes poderiam passar despercebidas. É aqui que identificamos as oportunidades existentes e o que podemos fazer para explorá-las.

Para explorar novas possibilidades, é necessário realizar uma análise ampla, com visão do todo, sem se aprofundar em todos os detalhes. É essencial fazer um "pré-filtro" para evitar sobrecarga de informações.

Neste capítulo, Greg também discute a criação de um ambiente favorável ao pensamento. O foco, muitas vezes considerado algo inato, pode ser cultivado. Estabelecer um momento de concentração pode variar desde encontrar um local tranquilo para pensar até reservar um tempo para si, recusando tarefas não prioritárias.
...
O objetivo deste capítulo é destacar formas de facilitar a execução de tarefas após identificar o que é essencial e eliminar o restante.

A primeira sugestão é elaborar um planejamento com vários cenários para o projeto, considerando a possibilidade de ocorrer imprevistos. Isso ajuda a estabelecer prazos e expectativas realistas. No ambiente corporativo, é comum subestimar prazos por receio de utilizar uma "margem de segurança", influenciados pela pressão social para concluir tarefas rapidamente.
...
Por fim, ressalta-se a importância de uma rotina alinhada com o essencialismo e focada no presente. A aplicação esporádica desses conceitos não gera um impacto significativo em comparação à aplicação consistente.

------------------------------------------------------------------------

Quando temos dificuldade em priorizar o que realmente importa, é fundamental lembrar da limitação do tempo que temos para alcançar nossos sonhos. Investir tempo e energia no que é verdadeiramente essencial reduz as chances de arrependimento futuro em relação às decisões tomadas.
